...
function reload(data) {
    ...
    for (let item of data) {
        ...
        text_one.innerHTML = item.title.length > 5 ? item.title.slice(0, 8 ) : item.title
...
function cartReload(data) {
    ...
    for (let item of data) {
        ...
        main_basket_right_title_text.innerHTML = item.title.length > 10 ? item.title.slice(0, 19) : item.title
